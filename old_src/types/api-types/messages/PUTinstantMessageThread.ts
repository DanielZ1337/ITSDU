...
const PUTinstantMessageThreadApiEndpoint = 'restapi/personal/instantmessages/messagethreads/{threadId}/v1'

export const PUTinstantMessageThreadApiUrl = (params: PUTinstantMessageThreadParams) => {
