import { ResourceFileTypeIndexedDB } from '@/queries/resources/useResourceByElementID'
...
export type IndexedDBResourceFileType = Omit<ResourceFileTypeIndexedDB, 'url' | 'text' | 'stream' | 'blob'> & {
	elementId: string
	last_accessed: Date
