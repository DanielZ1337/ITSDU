...
export default function CourseInformation() {
    ...
    const createSubjectDescriptionURL = new URL(`https://odin.sdu.dk/sitecore/index.php?a=searchfagbesk&bbcourseid=${course?.Code}`).toString()
        ...
        <div className="my-2 mb-4 flex flex-col px-8 pt-6 pb-8">
            ...
            <div className="-mx-3 mb-6 md:flex">
                ...
                <div className="mb-6 px-3 md:mb-0 md:w-1/2">
                    ...
                    <a className="text-base text-grey-darker hover:underline inline-flex hover:cursor-pointer"
