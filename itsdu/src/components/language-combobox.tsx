...
export function LanguageCombobox({ disabled }: { disabled?: boolean }) {
	const [field, setField] = React.useState<(typeof languages)[number]>(
		languages[0],
	);
	...
	return (
		<Popover>
			...
			<PopoverContent className="p-0 w-[200px]">
				<Command className="border-2 border-transparent border-purple-500 text-white text-foreground bg-foreground-200">
