	...
	return (
		<NavLink
			...
			className={({ isActive, isPending }) =>
				cn(
					"relative flex items-center gap-3 rounded-lg px-3 py-2 text-zinc-500 transition-all hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-50",
					isActive &&
						"lg:translate-x-1.5 text-zinc-900 dark:text-zinc-50 bg-foreground/10 shadow",
				...
				<>
					{isActive && (
						<m.div
							...
							className={
								"absolute inset-y-0 -left-7 w-3 rounded-r-lg bg-secondary-500"
							}
						/>
					)}
					{children}
