				...
				components={{
					header: (props) => {
						...
						return (
							<div
								className={cn(
									"flex items-center justify-center gap-2 h-full px-2 py-1.5",
								)}
							>
								...
								<PopoverTrigger asChild>
									<div
										...
										className={cn(
											...
											"active:!opacity-50 active:scale-95 transition-all !duration-75 ease-in-out cursor-pointer",
										)}
										style={props.children.props.style}
									>
										<span
											className={
												"inline-flex flex-col gap-2 text-white font-semibold text-sm"
											}
										>
