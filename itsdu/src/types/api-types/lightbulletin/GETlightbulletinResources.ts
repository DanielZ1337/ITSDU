...
const GETlightbulletinResourcesApiEndpoint =
	"restapi/personal/courses/bulletins/{bulletinId}/elements/v1?PageIndex={PageIndex}&PageSize={PageSize}";

export const GETlightbulletinResourcesApiUrl = (
