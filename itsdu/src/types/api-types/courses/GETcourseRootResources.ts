...
const GETcourseRootResourcesApiEndpoint =
	"restapi/personal/courses/{courseId}/resources/v1?PageIndex={PageIndex}&PageSize={PageSize}&elementType={elementType}&learningToolType={learningToolType}";

export const GETcourseRootResourcesApiUrl = (
