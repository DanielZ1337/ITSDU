...
import { ItslearningRestApiEntitiesReferencedInstantMessageType } from "@/types/api-types/utils/Itslearning.RestApi.Entities.ReferencedInstantMessageType.ts";
import { apiUrl } from "@/lib/utils.ts";

const POSTinstantMessagev2ApiEndpoint = "restapi/personal/instantmessages/v2";

export const POSTinstantMessagev2ApiUrl = () =>
	apiUrl(POSTinstantMessagev2ApiEndpoint);

export type POSTinstantMessagev2 =
