...
const GETpersonsRelationsApiEndpoint =
	"restapi/personal/person/relations/{personId}/v1";

export const GETpersonsRelationsApiUrl = (params: GETpersonsRelationsParams) =>
	apiUrl(GETpersonsRelationsApiEndpoint, params);
