...
export default function CourseParticipantsRolesSelect({roleIds, onChange}: {
    ...
    const CourseParticipantRoleLabelsFromRoleIds = Object.fromEntries(Object.entries(CourseParticipantRoleLabels).filter(([roleId]) => roleIds.includes(Number(roleId))))
                    ...
                    <DropdownMenuCheckboxItem
                        ...
                        onCheckedChange={(checked) => {
                            ...
                            if (checked) {
                                ...
                                newSelectedRolesIds.splice(newSelectedRolesIds.indexOf(Number(roleId)), 1)
                            }
