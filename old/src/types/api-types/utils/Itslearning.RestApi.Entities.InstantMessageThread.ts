...
} from "@/types/api-types/utils/Itslearning.RestApi.Entities.InstantMessage.ts";
import {
    ItslearningRestApiEntitiesThreadParticipant
} from "@/types/api-types/utils/Itslearning.RestApi.Entities.ThreadParticipant.ts";
import {
    ItslearningRestApiEntitiesLocationRecipient
} from "@/types/api-types/utils/Itslearning.RestApi.Entities.LocationRecipient.ts";
import {
    ItslearningRestApiEntitiesInstantMessageMassMessageType
} from "@/types/api-types/utils/Itslearning.RestApi.Entities.InstantMessageMassMessageType.ts";
