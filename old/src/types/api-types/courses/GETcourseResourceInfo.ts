...
export const GETcourseResourceInfoApiUrl = (params: GETcourseResourceInfoParams) => {
    return apiUrl(GETcourseResourceInfoApiEndpoint, params)
}

export type GETcourseResourceInfo = ItslearningRestApiEntitiesPersonalCourseCourseResourceWithRole
