...
import { lazy, useEffect, useRef, useState, memo, useMemo, useCallback } from 'react'
...
function DefaultPdfRenderer({ isLoading, url, isAISidepanelActive, toggleSidebar }: { isLoading: boolean, url?: string, isAISidepanelActive: boolean, toggleSidebar: () => void }) {
    if (isLoading || !url) {
        return (
