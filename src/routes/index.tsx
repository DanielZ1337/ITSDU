import {ClipboardList, StarIcon} from "lucide-react";
import {Suspense, useState} from "react";
import {GETstarredCoursesParams} from "@/api-types/course-cards/GETstarredCourses.ts";
import {Input} from "@/components/ui/input.tsx";
import {useDebounce} from "@uidotdev/usehooks";
import {Skeleton} from "@/components/ui/skeleton"
import {CourseCardsSortByTypes} from "@/api-types/extra/course-cards-sort-by-types.ts";
...
import {GETunstarredCoursesParams} from "@/api-types/course-cards/GETunstarredCourses.ts";
import useGETcourses from "@/queries/course-cards/useGETcourses.ts";

function CourseCards({config, courseCardTypes}: {
...
export default function Index() {
    ...
    const [selectedStarredOption, setSelectedStarredOption] = useState<string>("Starred")
            ...
            <div className={"flex flex-row flex-1 gap-4 flex-wrap justify-center"}>
                <div className={"items-center w-full h-full flex-wrap flex gap-4 justify-center flex-1 my-auto"}>
                    ...
                    <Suspense fallback={
                        ...
                        }} courseCardTypes={selectedStarredOption as "Starred" | "Unstarred" | "All"}
                        />
                    </Suspense>
                </div>
            </div>
