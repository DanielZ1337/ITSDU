...
export default function AIChats() {
	...
	if (
		data?.pages[0].totalFiles === 0 ||
		data?.pages[0].totalFiles === undefined ||
		data === undefined
	) {
		pagesNum = 0;
	} else {
	...
	if (
		...
		data?.pages[0].files.length === 0
	) {
		return (
			<div className="container mx-auto p-4 md:p-6">
				<h1 className="text-2xl md:text-3xl font-bold mb-6 xl:mb-16">
					Previous AI Chats
				</h1>
		...
		<Card className="w-full max-w-md m-auto">
			<CardContent className="p-4">
				<div className="flex justify-between items-center mb-2">
					...
					<Badge className="font-normal ml-2">
