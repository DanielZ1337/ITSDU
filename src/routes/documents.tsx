                            ...
                            <div
                                ...
                                <form onSubmit={handleSubmit}
                                    ...
                                    <Input onChange={(e) => setMessage(e.target.value)} value={message}
                                           disabled={messageIsLoading} type="text"
...
function Message({message, children, from}: {
    message?: string,
    ...
    return (
        <div className="flex flex-row items-start justify-start py-3 overflow-x-hidden">
            ...
            <div className="flex flex-col ml-2">
                ...
                <span
                    className={cn("text-white bg-primary/30 rounded-md p-2 shadow flex items-center justify-center w-fit whitespace-pre-wrap", from === "You" ? "bg-blue-500" : "bg-green-500/50")}>
