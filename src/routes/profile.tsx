			...
			<div className="mx-auto max-w-3xl rounded-lg border p-6 px-8 shadow-lg">
				...
				<div className="rounded-lg border px-4 py-8 bg-foreground/10">
					<div className="mb-4 flex items-center justify-center space-x-20">
						<div className="relative h-20 w-20 flex-shrink-0 overflow-hidden rounded-full group">
							...
							<ProfileAvatar
								...
								name={user.FullName}
								className={
									"border-3 border-primary/20 transition-all duration-75 w-full h-full absolute"
								}
					...
					<div className="grid grid-cols-2 gap-4 text-left text-sm text-gray-600">
						...
						<UserItem
							title="Can Access Message System"
							value={user.CanAccessMessageSystem ? "Yes" : "No"}
						/>
						<UserItem
						...
						/>
						<UserItem
							title="Can Access Personal Settings"
