...
export default function CourseCards({config, courseCardTypes}: {
    ...
    const unstarredCourses = data?.EntityArray.filter((course) => !course.IsFavouriteCourse)
        ...
        <div className={"flex flex-wrap gap-4 justify-center"}>
            ...
            {courseCardTypes === "Starred" && starredCourses?.length !== 0 && (
                <div className={"flex flex-col w-full gap-4"}>
                    <h1 className={"text-gray-500 flex gap-2 items-center justify-center text-sm sm:text-base md:text-lg font-semibold tracking-tighter"}>
                        Starred courses
                    </h1>
                    <div className={"flex flex-wrap gap-4 justify-center"}>
