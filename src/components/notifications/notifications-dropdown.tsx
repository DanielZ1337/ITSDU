...
export default function NotificationsDropdown() {
	...
	const { mutate: markAllAsRead, isLoading: isMarkingAllAsRead } = usePUTnotificationsMarkAllAsReadv2()
		...
		<DropdownMenu>
			<DropdownMenuTrigger asChild>
				...
				>
					...
					{unreadNotifications.length > 0 && <UnreadNotificationsPingIndicator amount={unreadNotifications.length} />}
				</Button>
			</DropdownMenuTrigger>
			<DropdownMenuContent>
				<DropdownMenuLabel className={'flex justify-between items-center'}>
					...
					>
						<span className={'text-base font-medium group-hover:underline'}>Notifications</span>
						<ArrowRightIcon
