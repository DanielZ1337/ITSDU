...
export function useUpdatesTypeSelect<T extends GETcourseNotifications | GETnotificationsStream>(notifications: InfiniteData<T> | undefined) {
    const [selectedUpdatesType, setSelectedUpdatesType] = useState<UpdatesType>("all")

    const filteredNotifications = getFilteredUpdates<T>(notifications, selectedUpdatesType)
...
export function getFilteredUpdates<T extends GETcourseNotifications | GETnotificationsStream>(updates: InfiniteData<T> | undefined, updateType: UpdatesType) {
