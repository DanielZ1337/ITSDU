            ...
            {showResources && (
                <div className="mt-4 mb-4 flex flex-col space-y-4 border rounded-lg p-4">
                    {Resources!.EntityArray.map((resource) => (
                        <div className={"hover:cursor-pointer hover:bg-foreground/5 py-2 px-4 rounded-lg group/attachment"} key={resource.ElementId} onClick={() => {
                            window.app.openExternal(resource.ContentUrl, true)
                        }}>
                            <div className="flex items-center space-x-2 text-blue-500 group-hover/attachment:text-blue-600">
