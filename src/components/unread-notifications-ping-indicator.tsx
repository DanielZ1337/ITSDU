export default function UnreadNotificationsPingIndicator({
  ...
  return (
    <span className="absolute top-0 right-0 flex h-[20px] w-[20px]">
      <span className="absolute inline-flex h-full w-full animate-ping rounded-full opacity-75 bg-primary"></span>
      <span className="relative inline-flex rounded-full h-[20px] w-[20px] bg-primary">
