        ...
        <div className="flex h-screen max-h-screen min-h-screen flex-col overflow-hidden">
            ...
            <div className="flex items-center justify-between border-b px-4 py-2 drag border-background/40">
                ...
                <div className="w-full max-w-xl px-4">
                    <ErrorBoundary
                        fallback={<Suspense fallback={<TitlebarButtonLazy disabled/>}><TitlebarButtonLazy/></Suspense>}>
                ...
                <div className={"no-drag flex flex-row items-center justify-center gap-4"}>
                    <ErrorBoundary fallback={<Suspense
                        fallback={<MessagesDropDownSkeleton/>}><MessagesDropDownSkeleton/></Suspense>}>
                        <Suspense fallback={<MessagesDropDownSkeleton/>}>
                            <MessagesDropdown/>
                        </Suspense>
                    </ErrorBoundary>
                    <ErrorBoundary
                        fallback={<Suspense fallback={<NotificationsDropDownSkeleton/>}><NotificationsDropDownSkeleton/></Suspense>}>
