			...
			<AnimatePresence>
				{starred && (
					<m.span
						...
						className={
							"absolute flex flex-row gap-2 items-center justify-center"
						}
					>
						<StarIcon
							className={
								"stroke-secondary-500 fill-secondary-500 shrink-0 m-1 h-6 w-6"
							}
						/>
						<span>Starred</span>
					</m.span>
				...
				{!starred && (
					...
					>
						<span className={"relative h-6 w-6 shrink-0 ml-1"}>
							<StarHalfIcon
								className={
									"absolute stroke-secondary-500 fill-secondary-500 h-6 w-6"
								}
							/>
