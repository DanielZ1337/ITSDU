...
export default function MessagesAddRecipients() {
    ...
    const { data: recipientsSearch, isFetching: isRecipientsLoading } = useGETinstantMessagesRecipientsSearch({
    ...
    useEffect(() => {
        ...
        setFilteredRecipients(recipientsSearch.filter((recipient) => !recipientsSelected.includes(recipient)))
                            ...
                            <div className="flex flex-wrap gap-2 overflow-y-auto overflow-x-hidden">
                                {filteredRecipients.map((recipient) => (
                                    <Button
                                        ...
                                        key={recipient.Id} variant={"secondary"}
