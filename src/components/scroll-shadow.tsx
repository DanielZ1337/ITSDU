...
export function calculateShadowPosition(viewportRef?: React.RefObject<HTMLDivElement>): ShadowPosition {
...
export function Shadow({ position }: { position: ShadowPosition }) {
    ...
    const topClassName = 'top-0 bg-gradient-to-t from-transparent dark:to-neutral-800 to-neutral-100'
    const bottomClassName = 'bottom-0 bg-gradient-to-b from-transparent dark:to-neutral-800 to-neutral-100'
    ...
    return (
        <AnimatePresence>
            ...
            {position === 'both' && <>{topComponent()}{bottomComponent()}</>}
        </AnimatePresence>
    )
}