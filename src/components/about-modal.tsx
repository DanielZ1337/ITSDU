        ...
        <DialogContent className="md:w-fit">
              ...
              <span className="text-sm text-gray-500">
                ...
                {isUpdateAvailable && updateResult && (
                  ...
                  >
                    ...
                    {isDownloading ? `${downloadProgress.toFixed(2)}%` : "Download"}
                  </button>
                )}
              </span>
              <span className="text-sm text-gray-500">
          ...
          <div className="flex p-4">
            ...
            <p className="text-sm text-gray-500">
              ITSDU is a desktop app built for students at SDU to access itslearning in a
              more convenient way.
              <br />
              <br />
          ...
          <DialogFooter className="flex items-center sm:justify-between w-full">
            <a
              ...
              onClick={() =>
                void window.app.openExternal("https://itsdu.danielz.dev/releases", false)
              }
            >
              Releases{" "}
