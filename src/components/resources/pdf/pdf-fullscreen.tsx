...
const PdfFullscreen = ({ fileUrl }: PdfFullscreenProps) => {
	...
	const { setNumPages, numPages, currPage, setCurrPage, setValue } =
		useCustomPDFContext();
	...
	return (
		<TooltipProvider delayDuration={300}>
			...
			>
				...
				<DialogContent
					className="w-full max-w-7xl no-drag p-0 gap-0 overflow-hidden bg-background"
					customClose={<></>}
				>
					{/* Fullscreen toolbar */}
					...
					>
						...
						>
							{Array.from(new Array(numPages), (_, index) => (
								...
								>
									<div data-page-number={index + 1} className="relative mb-4">
										<Page
											pageNumber={index + 1}
