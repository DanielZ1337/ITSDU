...
function UpdatesCommandList({ courseId, isResourcesFetching, handleSelect, navigateToResource }: { courseId?: number, isResourcesFetching: boolean, handleSelect: (callback: () => unknown) => void, navigateToResource: (resource: any) => void }) {
    ...
    return (
        <>
            ...
            {allUpdates && allUpdates.length > 0 && !isLoading && (
                <CommandGroup
                    heading={`${allUpdates?.length} updates found`}
                >
...
function ResourcesCommandList({ courseId, navigate, handleSelect, query }: { courseId?: number, navigate: any, handleSelect: (callback: () => unknown) => void, query: string }) {
...
function CoursesCommandList({ isStarredFetching, isUnstarredFetching, starredCourses, unstarredCourses, navigate, handleSelect }: { isStarredFetching: boolean, isUnstarredFetching: boolean, starredCourses?: GETstarredCourses, unstarredCourses?: GETunstarredCourses, navigate: NavigateFunction, handleSelect: (callback: () => unknown) => void }) {
    return (
        <>
            <CommandEmpty
