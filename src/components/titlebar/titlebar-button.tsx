	...
	({ onClick, className, ...props }, ref) => {
		return (
			...
			>
				...
				<kbd className="transition-colors duration-1000 pointer-events-none absolute right-2 my-auto flex h-5 select-none items-center gap-1 rounded border font-mono font-medium opacity-100 dark:group-hover:bg-primary/5 dark:group-hover:border-primary/10  bg-muted px-1.5 text-[10px]">
