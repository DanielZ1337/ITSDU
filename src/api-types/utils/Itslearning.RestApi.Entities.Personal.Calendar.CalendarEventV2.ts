...
} from "@/api-types/utils/Itslearning.RestApi.Entities.Personal.Calendar.Attendance.AttendanceDetails.ts";
import {
    ItslearningRestApiEntitiesPersonalCalendarCalendarEventType
} from "@/api-types/utils/Itslearning.RestApi.Entities.Personal.Calendar.CalendarEventType.ts";
