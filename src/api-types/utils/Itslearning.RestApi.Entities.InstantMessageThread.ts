...
} from "@/api-types/utils/Itslearning.RestApi.Entities.InstantMessage.ts";
import {
    ItslearningRestApiEntitiesThreadParticipant
} from "@/api-types/utils/Itslearning.RestApi.Entities.ThreadParticipant.ts";
import {
    ItslearningRestApiEntitiesLocationRecipient
} from "@/api-types/utils/Itslearning.RestApi.Entities.LocationRecipient.ts";
import {
    ItslearningRestApiEntitiesInstantMessageMassMessageType
} from "@/api-types/utils/Itslearning.RestApi.Entities.InstantMessageMassMessageType.ts";
