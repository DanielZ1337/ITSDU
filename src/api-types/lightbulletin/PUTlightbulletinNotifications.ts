...
const PUTlightbulletinNotificationsApiEndpoint = "restapi/personal/lightbulletins/{lightBulletinId}/comments/subscription/v1"

export const PUTlightbulletinNotificationsApiUrl = (params: PUTlightbulletinNotificationsParams) => {
