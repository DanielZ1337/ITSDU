...
const GETcourseTasklistDailyWorkflowApiEndpoint = "restapi/personal/tasklistdailyworkflow/{courseId}/v1?PageIndex={PageIndex}&PageSize={PageSize}"

export const GETcourseTasklistDailyWorkflowApiUrl = (params: GETcourseTasklistDailyWorkflowParams) => {
