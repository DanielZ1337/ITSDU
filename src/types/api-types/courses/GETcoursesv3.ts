...
import { ItslearningRestApiEntitiesPersonCourseCardData } from "@/types/api-types/utils/Itslearning.RestApi.Entities.PersonCourseCardData.ts";

const GETcoursesv3ApiEndpoint =
	"restapi/personal/courses/v3?PageIndex={PageIndex}&PageSize={PageSize}&filter={filter}";
