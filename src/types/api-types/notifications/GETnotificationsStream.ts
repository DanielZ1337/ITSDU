...
const GETnotificationsStreamApiEndpoint =
  "restapi/personal/notifications/stream/v2?showLightBulletins={showLightBulletins}&UseNewerThan={UseNewerThan}&FromId={FromId}&PageIndex={PageIndex}&PageSize={PageSize}";

export const GETnotificationsStreamApiUrl = (params: GETnotificationsStreamParams) =>
  apiUrl(GETnotificationsStreamApiEndpoint, params);
