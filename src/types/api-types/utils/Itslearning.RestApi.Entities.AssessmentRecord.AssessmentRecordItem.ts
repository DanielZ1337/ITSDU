import { ItslearningPlatformRestApiSdkCommonEntitiesWhenToShowResult } from "@/types/api-types/utils/Itslearning.Platform.RestApi.Sdk.Common.Entities.WhenToShowResult.ts";
