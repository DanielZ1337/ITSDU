...
export function isResourceCustom(resource: ResourceObject | string | number) {
	...
	const supportedCustomResources = [
		LearningToolIdTypes.REGISTRATION,
		LearningToolIdTypes.FILE,
		// LearningToolIdTypes.BOOK,
		// LearningToolIdTypes.LINK,
	];

	return (
		(resource.LearningToolId &&
			supportedCustomResources.includes(resource.LearningToolId)) ||
		(resource.IconUrl &&
			supportedCustomResources.includes(
