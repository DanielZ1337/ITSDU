...
export const GETinstantMessageThreadApiUrl = (params: GETinstantMessageThreadParams) => {
...
export type GETinstantMessageThread = ItslearningRestApiEntitiesInstantMessageThread
