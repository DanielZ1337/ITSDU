...
const GETinstantMessagesv3ApiEndpoint =
	"restapi/personal/instantmessages/messagethreads/v3?fromSortIndex={fromSortIndex}&pageSize={pageSize}";

export const GETinstantMessagesv3ApiUrl = (
